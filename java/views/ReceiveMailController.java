...
public class ReceiveMailController extends MasterController {
	@FXML
...
//		MainApp.app.loadPage("receiveMail");
	...
	public void delete() {
		...
		String sql = "DELETE FROM `mail_item` WHERE receive = ?";
	...
	public void reload() {
		...
		String sql = "SELECT `id`, `owner`, `title`, `date`  FROM `mail_item` WHERE receive = ? ORDER BY `id` DESC";
